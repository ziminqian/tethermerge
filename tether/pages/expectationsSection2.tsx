      ...
      <View style={localStyles.container}>
        ...
        >
          ...
          <View style={localStyles.bulletList}>
            <Text style={localStyles.bulletPoint}>• Their reaction</Text>
            <Text style={localStyles.bulletPoint}>• Whether they agree with you</Text>
            <Text style={localStyles.bulletPoint}>• Their emotional state</Text>
            <Text style={localStyles.bulletPoint}>• How long they need to process</Text>
          </View>
