    ...
    >
      <View style={expectationStyles.container}>
        ...
        >
          ...
          <Text style={expectationStyles.sectionTitle}>What You Cannot Control</Text>
          
          <View style={expectationStyles.bulletList}>
            <Text style={expectationStyles.bulletPoint}>• Their reaction</Text>
            <Text style={expectationStyles.bulletPoint}>• Whether they agree with you</Text>
            <Text style={expectationStyles.bulletPoint}>• Their emotional state</Text>
            <Text style={expectationStyles.bulletPoint}>• How long they need to process</Text>
          </View>

          <Text style={expectationStyles.prompt}>What are you worried about that might be outside your control?</Text>
