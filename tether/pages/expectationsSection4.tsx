      ...
      <View style={localStyles.container}>
        ...
        >
          <View style={localStyles.content}>
            <Text style={localStyles.sectionTitle}>Your Minimum Acceptable Outcome</Text>
            ...
            <View style={localStyles.bulletList}>
              <Text style={localStyles.bulletPoint}>• Sharing your perspective clearly</Text>
              <Text style={localStyles.bulletPoint}>• Setting a boundary</Text>
              <Text style={localStyles.bulletPoint}>• Asking for time, space, or clarity</Text>
            </View>
